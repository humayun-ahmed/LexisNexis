...
namespace FileHandler.Client
{
	internal class Program
	{
		private static void Main(string[] args)
		{
			...
			FileHandlerService.SplitDirectoryFile(filePath2, out directory2, out fileName2);
			...
			FileHandlerService.SplitDirectoryFile(filePath3, out directory3, out fileName3);
			...
			FileHandlerService.SplitDirectoryFile(filePath4, out directory4, out fileName4);
